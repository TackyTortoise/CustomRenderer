...
public:
	...
	virtual ~Object() { MaterialManager::UnLoadMaterial(m_Material); }
	...
	void SetMaterial(const char* name) { MaterialManager::UnLoadMaterial(m_Material); m_Material = MaterialManager::LoadMaterial(name); }
	void SetMaterial(Material* newMat) { MaterialManager::UnLoadMaterial(m_Material); m_Material = newMat; }
